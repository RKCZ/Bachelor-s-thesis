...
\input{chapters/simulator-comparison}

\chapter{Overview of other used libraries}
\input{chapters/library-overview}

\appendix
\input{appendices/PyNN_architecture}
\input{appendices/community_of_the_simulators}
\input{appendices/documentation_of_the_simulators}
\input{appendices/computation_features_of_the_spiking_simulators}
% 
